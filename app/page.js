...
export default function Home() {
  ...
  const handleLogin = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://g2ixr6izoi1zdq-8000.proxy.runpod.net/auth/login", {
        method: "POST",
  ...
  const handleSignup = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://g2ixr6izoi1zdq-8000.proxy.runpod.net/auth/signup", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        ...
        <section className="mb-8 bg-white/80 backdrop-blur-sm rounded-3xl border border-gray-200/50 p-4 sm:p-6 lg:p-10 shadow-xl">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="bg-white/50 rounded-2xl p-6 border border-gray-200">
              <h3 className="text-xl font-bold text-gray-800 mb-4">What is HumanoText?</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
                HumanoText is an advanced AI text processing platform that offers multiple tools to enhance and improve AI-generated content. 
                Our platform includes three main features: Text Humanizer, AI Detection, and Paraphrase tools.
              </p>
              <p className="text-gray-700 leading-relaxed">
                Whether you're a content creator, student, or professional, our tools help you create content that 
            ...
            <div className="bg-white/50 rounded-2xl p-6 border border-gray-200">
              <h3 className="text-xl font-bold text-gray-800 mb-4">What are the Different Processing Modes?</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
                Our platform offers three different processing modes to meet various content needs:
              </p>
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-gray-800 mb-2">Normal Mode</h4>
                  <p className="text-gray-700 leading-relaxed">
                    Standard text humanization that makes AI content sound more natural and human-like. 
                    Perfect for general content improvement and readability enhancement.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-800 mb-2">Power Mode</h4>
                  <p className="text-gray-700 leading-relaxed">
                    Advanced processing with enhanced algorithms for more sophisticated text transformation. 
                    Ideal for complex content that requires deeper humanization.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-800 mb-2">Paraphrase Mode</h4>
                  <p className="text-gray-700 leading-relaxed">
                    Text rewriting that maintains the original meaning while changing the structure and vocabulary. 
                    Great for creating variations of existing content.
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* How to Use */}
            <div className="bg-white/50 rounded-2xl p-6 border border-gray-200">
              <h3 className="text-xl font-bold text-gray-800 mb-4">How to Use HumanoText</h3>
              <ol className="list-decimal list-inside text-gray-700 space-y-2 ml-4">
                <li><strong>Paste your text</strong> into the input field (max 200 words per request)</li>
                <li><strong>Choose your processing mode</strong> (Normal, Power, or Paraphrase)</li>
                <li><strong>Select your writing style</strong> (Normal, Formal, or Academic)</li>
                <li><strong>Click the process button</strong> to transform your text</li>
            ...
            {/* AI Detection Tool */}
            <div className="bg-white/50 rounded-2xl p-6 border border-gray-200">
              <h3 className="text-xl font-bold text-gray-800 mb-4">What is the AI Detection Tool?</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
                Our AI Detection tool analyzes text patterns, vocabulary complexity, sentence structure, and writing style to 
                identify whether content was generated by artificial intelligence or written by a human.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
                This tool is useful for:
              </p>
              <ul className="list-disc list-inside text-gray-700 ml-4 mt-2 space-y-1">
                <li>Checking the authenticity of content before submission</li>
                <li>Understanding how AI detection systems work</li>
                <li>Testing the effectiveness of our humanization tools</li>
                <li>Ensuring content meets academic or professional standards</li>
              </ul>
              <p className="text-gray-700 leading-relaxed mt-4">
                <strong>Requirements:</strong> Minimum 80 words, maximum 1000 words per analysis.
              </p>
            </div>
            ...
            <div className="bg-white/50 rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                You can use our tools with complete confidence knowing your data is protected.
              </p>
              <div className="mt-4 text-sm text-gray-600">
                <p><strong>Important Notice:</strong> Our tools are designed to make AI-generated content sound more natural and human-like. 
