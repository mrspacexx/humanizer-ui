          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="bg-white/50 rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                AI Text Humanizer is an advanced tool that transforms AI-generated content into natural, human-like writing. 
                It uses sophisticated algorithms to rewrite text in a way that sounds more authentic and bypasses AI detection tools.
              </p>
            ...
            <div className="bg-white/50 rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-gray-700 leading-relaxed">
                Our humanizer bypasses AI detection by:
              </p>
              <ul className="list-disc list-inside text-gray-700 ml-4 mt-2 space-y-1">
                <li>Varying sentence structure and length</li>
                ...
                <li>Maintaining topic relevance while sounding authentic</li>
              </ul>
            </div>
            ...
            <div className="bg-white/50 rounded-2xl p-6 border border-gray-200">
              ...
              <ol className="list-decimal list-inside text-gray-700 space-y-2 ml-4">
                ...
                <li><strong>Review the humanized output</strong> and copy it to your clipboard</li>
                <li><strong>Use the transformed text</strong> in your content, assignments, or communications</li>
              </ol>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <ul className="list-disc list-inside text-gray-700 text-sm space-y-1">
                    <li>Bypass AI detection in assignments</li>
                    <li>Improve writing quality</li>
                    <li>Learn different writing styles</li>
            ...
            <div className="bg-white/50 rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                All processing happens in real-time and is immediately deleted after humanization.
              </p>
              <p className="text-gray-700 leading-relaxed">
